        ...
        <div class="container section-content">
            ...
            <div class="info-cards">
                <div class="info-card">
                    ...
                    <p>Learn proper feeding schedules, water quality management, disease prevention, and optimal growing
                        conditions for different fish species.</p>
                </div>

                <div class="info-card">
                    <i class="material-icons">trending_up</i>
                    <h5>Business Operations</h5>
                    <p>Understand market pricing, cost management, profit optimization, record keeping, and scaling your
                        fish farm enterprise effectively.</p>
                </div>

                <div class="info-card">
                    <i class="material-icons">science</i>
                    <h5>Technical Support</h5>
                    <p>Access guidance on equipment maintenance, water testing procedures, pond management, and
                        troubleshooting common operational issues.</p>
                </div>

                <div class="info-card">
                    <i class="material-icons">schedule</i>
                    <h5>Fish Farm Routines</h5>
                    <p>Get structured daily, weekly, and seasonal routines for pond maintenance, feeding cycles, and
                        operational scheduling.</p>
                </div>
            </div>
