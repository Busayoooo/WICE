...
<body class="pink lighten-5">
    ...
    <div class="container">
        ...
        <h3 class=" blue-text text-lighten-1 bold-txt center">Overview of WISE</h3>
        ...
        <h4 class="blue-text text-lighten-1 bold-txt">Our Mission</h4>
        <div class="divider"></div>
        <p class="grey-text text-darken-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. A repellendus at, nam illo rerum ullam expedita voluptatum porro. Sequi, optio! Hic vitae officia natus, numquam molestias, expedita, alias amet nisi harum 
        </p>
        <div class="divider"></div>

        <h2 class="blue-text text-lighten-1">News</h2>
        <div class="outline">
            <div class="row">
                <div class="col l4">
