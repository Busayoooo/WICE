...
<body class="background">
    <!-- History of WICE -->
    <div class="container">
        <h2 class="blue-text section-heading text-lighten-1 hidden fade-in-left bold-txt hide-on-med-and-down">History
            of WICE</h2>
        <h3 class="blue-text section-heading text-lighten-1 hidden fade-in-left bold-txt hide-on-large-only center">
            History of WICE</h3>
        <p class=" grey-text text-darken-3 flow-text hidden fade-in-right">A short history of Wisdom College of
            Excellence (WICE) in Iwopin, Ogun Waterside LGA, Ogun State, Nigeria. <br> <br>
            ...
            Nigeria, a group of visionary individuals came together to establish a private school that would provide
            quality education to the children of the community. The year was 2019, and the community was facing
            significant challenges, including overfishing, high mortality rate, early marriages/pregnancy, poverty,
            limited access to education, and a lack of opportunities for social mobility...
    ...
    <div id="History" class="modal">
        <div class="modal-content">
            ...
            <p class="">
                A short history of Wisdom College of Excellence (WICE) in Iwopin, Ogun Waterside LGA, Ogun State,
                Nigeria.
                <br><br>
                <strong class="bold-txt">The Founding of Wisdom College of Excellence (WICE):</strong>
                <br><br>
                In the small fishing community of Iwopin, located in the Ogun Waterside Local Government Area of Ogun
                State, Nigeria, a group of visionary individuals came together to establish a private school that would
                provide quality education to the children of the community. The year was 2019, and the community was
                facing significant challenges, including overfishing, high mortality rate, early marriages/pregnancy,
                poverty, limited access to education, and a lack of opportunities for social mobility.
                <br><br>
                Despite these challenges, the founders of Wisdom College of Excellence (WICE) were determined to create
                a institution that would empower the children of Iwopin with the knowledge, skills, and values necessary
                to succeed in life. The school's mission was to provide a holistic education that would prepare students
                for academic excellence, personal growth, and community leadership.
                <br><br>
                <strong class="bold-txt">Early Years (2019-2020):</strong>
                <br><br>
                WICE began with a humble start, with a small group of students and a handful of teachers. The school was
                housed in a temporary facility, and the curriculum was focused on providing a solid foundation in core
                subjects such as English, mathematics, science, computer studies and social studies. Despite the
                challenges of limited resources and infrastructure, the school's founders and staff were committed to
                providing a high-quality education that would meet the needs of the community.
                <br><br>
                <strong class="bold-txt">Growth and Development (2020-Present):</strong>
                <br><br>
                In the years since its founding, WICE has experienced significant growth and development. The school has
                expanded its curriculum to include a range of subjects, including computer science, arts, and music. The
                school has also introduced extracurricular activities, such as sports, debate, and cultural clubs, to
                provide students with opportunities for personal growth and development.
                <br><br>
                In 2020, WICE relocated to a new, purpose-built facility that provides a safe and conducive learning
                environment for students. The school has also invested in modern technology, including computers,
                tablets, and educational software, to enhance the learning experience.
                <br><br>
                <strong class="bold-txt">Community Engagement and Partnerships:</strong>
                <br><br>
                WICE is committed to engaging with the local fishing community, established fish farm, advancing
                community health, Poverty reduction and forming partnerships with organizations and individuals who
                share its mission and values. The school has established relationships with local businesses, community
                groups, and government agencies to provide students with opportunities for internships, mentorship, and
                community service. This partnership is supporting to overcoming adversity in the community.
                <br><br>
                In 2022, WICE launched a community digital literacy outreach program, which provides support to young
                people, local families and individuals in need to learning computers and digital tools for growth and
                transformation. Other community outreach program includes initiatives such as literacy classes, Gender
                Based violence, health clinics, and economic empowerment schemes.
                <br><br>
                <strong class="bold-txt">Vision for the Future:</strong>
                <br><br>
                As WICE looks to the future, the school is committed to continuing its mission of providing a
                high-quality education that empowers the children of Iwopin to succeed in life. The school's vision is
                to become a leading institution in the region, known for its academic excellence, innovative approaches
                to education, and commitment to community development.
                <br><br>
                With the support of its founders, staff, students, and the local community, WICE is poised to make a
                positive impact on the lives of generations to come. The school's motto, "Skills for Today Future
                Leader," reflects its commitment to providing a holistic education that prepares students for success in
                all aspects of life.
            </p>
        </div>
    ...
    <div class="parallax-container hide-on-med-and-down">
        <div class="vision-div parallax">
            ...
            <h5 class="white-text hide-on-med-and-down">"A society where learning is transformed for Brighter Future"
            </h5>
        </div>
    </div>
                ...
                <div class="card hoverable ">
                    ...
                    <div class="card-action hover-trigger center">
                        ...
                        <div class="contact-icons hidden">
                            <a href="tel:+1234567890" class="tooltipped icon-wrapper" data-position="top"
                                data-tooltip="Call Me">
                                <i class="material-icons">phone</i>
                            </a>
                            <a href="mailto:Wceiwopin@gmail.com" class="tooltipped icon-wrapper" data-position="top"
    ...
    <div class="container section-spacing">
        <div class="hidden fade-in-left">
            ...
            <p class="center grey-text text-darken-2">Transforming lives through education, health, and sustainable
            ...
            <div class="col l4 m6 s12 hidden fade-in-bottom">
                <div class="card long-card hoverable">
                    <div class="card-content center">
                        ...
                        <p>Free summer digital literacy program empowering young minds with essential 21st-century
                            skills.</p>
                        <ul class="left-align">
            ...
            <div class="col l4 m6 s12 hidden fade-in-bottom">
                <div class="card long-card hoverable">
                    <div class="card-content center">
                        ...
                        <p>Community health outreach promoting physical well-being and preventive healthcare practices.
                        </p>
                        <ul class="left-align">
            ...
            <div class="col l4 m6 s12 hidden fade-in-bottom">
                <div class="card long-card hoverable">
                    <div class="card-content center">
                        ...
                        <p>Literacy and numeracy competitions recognizing outstanding academic achievement in
                            partnership with ISCON.</p>
                        <ul class="left-align">
            ...
            <div class="col l4 m6 s12 hidden fade-in-bottom">
                <div class="card long-card hoverable">
                    <div class="card-content center">
                        ...
                        <p>Documenting and celebrating local heritage through multimedia storytelling and community
                            engagement.</p>
                        <ul class="left-align">
            ...
            <div class="col l4 m6 s12 hidden fade-in-bottom">
                <div class="card long-card hoverable">
                    <div class="card-content center">
                        ...
                        <p>Environmental stewardship through tree nursery training and community tree planting
                            initiatives.</p>
                        <ul class="left-align">
            ...
            <div class="col l4 m6 s12 hidden fade-in-bottom">
                <div class="card long-card hoverable">
                    <div class="card-content center">
                        ...
                        <p>Sustainable aquaculture and fisheries conservation through innovative school-based fish farm
                            enterprise.</p>
                        <ul class="left-align">
    ...
    <div class="cta-section achievements-section">
        <div class="container">
            <div class="hidden fade-in-left">
                ...
                <p class="center white-text" style="opacity: 0.9;">Measurable results that make a difference in our
                    community</p>
            </div>
            <div class="row">
                ...
                <div class="col l3 m6 s12 center hidden fade-in-bottom">
                    <div class="white-text">
                        <i class="material-icons large white-text">computer</i>
                ...
                <div class="col l3 m6 s12 center hidden fade-in-bottom">
                    <div class="white-text">
                        <i class="material-icons large white-text">eco</i>
